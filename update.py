...
def main():
    ...
    #TODO: update the assets for the Assets
    #set _BIN=%VISION_SDK%\Bin\win32_vs2010_anarchy\dev_dll\DX9
    #set AP=%_BIN%\AssetProcessor.exe
    #set PROJECT=%~dp0\Assets
    #%AP% --removestale=1 --transform=1 --all=1 "%COURSEWARE%"
